...
;	stri	r3,#DATA8		; C7 21
	...
	.sbttl	str_ 'Direct Register Offser' Instruction Tests

	stra	r0,ADDR,R0			; CC 72 34
	stra	r0,ADDR,R1			; CD 72 34
	stra	r0,ADDR,r2			; CE 72 34
	stra	r0,ADDR,r3			; CF 72 34

	stra	r0,ADDR,+R0			; CC 32 34
	stra	r0,ADDR,+R1			; CD 32 34
	stra	r0,ADDR,+r2			; CE 32 34
	stra	r0,ADDR,+r3			; CF 32 34

	stra	r0,ADDR,-R0			; CC 52 34
	stra	r0,ADDR,-R1			; CD 52 34
	stra	r0,ADDR,-r2			; CE 52 34
	stra	r0,ADDR,-r3			; CF 52 34
...
;	lodz	r0			; 00
	...
	loda	r0,ADDR,R0			; 0C 72 34
	loda	r0,ADDR,R1			; 0D 72 34
	loda	r0,ADDR,r2			; 0E 72 34
	loda	r0,ADDR,r3			; 0F 72 34

	loda	r0,ADDR,+R0			; 0C 32 34
	loda	r0,ADDR,+R1			; 0D 32 34
	loda	r0,ADDR,+r2			; 0E 32 34
	loda	r0,ADDR,+r3			; 0F 32 34

	loda	r0,ADDR,-R0			; 0C 52 34
	loda	r0,ADDR,-R1			; 0D 52 34
	loda	r0,ADDR,-r2			; 0E 52 34
	loda	r0,ADDR,-r3			; 0F 52 34
